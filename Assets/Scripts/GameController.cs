...
public class GameController : MonoBehaviour
{
    ...
    private class InGame : GameState
    {
        public override void OnEnter()
        {
            ...
            var player = new UserControlledPlayer(playerGameObject, new[] { KeyCode.W, KeyCode.S, KeyCode.A, KeyCode.D });
            player.SetPosition(UnityEngine.Random.Range(0.0f, -8.0f), UnityEngine.Random.Range(-4.0f, 4.0f), true);
            Services.Players = new[] { player };
